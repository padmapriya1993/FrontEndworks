...
<html lang="en">
  ...
  <div class="card mb-3">
    <div class="row g-0 d-flex align-items-center">
      ...
      <div class="col-lg-8">
        ...
        <form style="width:50% float: left;display:inline;" action="userdetail.php" method="post" enctype="multipart/form-data">
  ...
  <div class="form-outline mb-4">
                            ...
                            <div class="input-group">
                                    ...
                                    <a id="forgot" href="reset.php">forgot password?</a>                     
                            <div>
                            <button class="btn btn--radius-2 btn--red"  name="login" type="submit">LOGIN</button></div>
